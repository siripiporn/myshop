...
class Monitor extends Component {
	...
	confirmOrder() {
		...
		axios.post('http://localhost:3001/orders', { orderedDate: new Date(), totalPrice, orders }).then(res => {
			this.setState({ totalPrice: 0, orders: [], confirm: true,msg:'	บันทึกการสั่งซื้อเรียบร้อยค่ะ' });
		});
	} else {
